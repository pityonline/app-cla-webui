    ...
    export default {
        ...
        methods: {
            ...
            previewOrgSignature(row) {
                ...
                this.url = `../../public/static/pdf_source/web/viewer.html?file=${url.downloadSignature}/${row.id}`
                // this.url = `../../public/static/pdf_source/web/viewer.html?file=../../public/static/pdf/merge.pdf`
                this.previewOriginalDialogVisible = true
            },
