...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            loginByGithub(){
                window.location.href = 'https://github.com/login/oauth/authorize?client_id=d86f4915398dad23bffc&redirect_uri=http://localhost:8080/home&scope=user%20repo%20admin:org'  //逗号分隔多个权限
            },
            findPwd(){
