        ...
        methods: {
            ...
            loginIn() {
                ...
                switch (this.value) {
                    case '0':
                        console.log("case0");
                        window.location.href = 'https://gitee.com/oauth/authorize?client_id=2632e89d3dfb17ce941d2d2b45efc6f235afb4941ddb67578adda83aa33ab6a2&redirect_uri=http://139.159.224.207:60031/apis/v1/login?platform=gitee&response_type=code&scope=user_info%20groups%20emails';
