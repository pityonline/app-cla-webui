...
export default new Vuex.Store({
    state: {
        ...
        repositoryValue: Number(sessionStorage.getItem('repositoryValue')) || undefined,
        claValue: Number(sessionStorage.getItem('claValue')) || undefined,
        orgValue: Number(sessionStorage.getItem('orgValue')) || undefined,
