...
export const individual_signing = '/v1/individual-signing'    //个人签署协议 参数 cla_org_id,email,info
export const corporation_signing = '/v1/corporation-signing'    //企业签署协议 参数  cla_org_id,email,info
export const employee_signing = '/v1/employee-signing'    //企业个人签署协议 参数     cla_org_id,email,info
