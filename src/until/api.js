...
export const getLinkedRepoList = '/v1/cla-org'                                         //获取已绑定的开源项目list   get
...
export const employee_signing = '/v1/employee-signing'                                 //企业个人签署协议 方式post 参数  name,cla_org_id,email,info
...
export const getAuthEmails = 'https://gitee.com/api/v5/emails'                         //获取授权用户的邮箱   方式get   参数access_token
